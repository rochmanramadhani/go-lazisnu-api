...
var errorConstant errorHelper = errorHelper{
	...
	NotFound: Error{
		Response: errorResponse{
			Meta: Meta{
				Success: false,
				Message: resConstant.CODE_TO_MESSAGE[resConstant.E_RECORD_NOTFOUND],
				Code:    resConstant.E_RECORD_NOTFOUND,
			},
			Error: resConstant.CODE_TO_MESSAGE[resConstant.E_RECORD_NOTFOUND],
		},
	...
	EmailUsed: Error{
		Response: errorResponse{
			Meta: Meta{
				Success: false,
				Message: resConstant.CODE_TO_MESSAGE[resConstant.E_EMAIL_USED],
				Code:    resConstant.E_EMAIL_USED,
			},
			Error: resConstant.CODE_TO_MESSAGE[resConstant.E_EMAIL_USED],
		},
		HttpCode: http.StatusConflict,
	},
}
...
func ErrorBuilder(res Error, err error, customMessage ...string) *Error {
	...
	if strings.Contains(strings.Join([]string{
		...
		resConstant.CODE_TO_MESSAGE[resConstant.E_EMAIL_USED],
	}, ","), res.Response.Error) {
